...
public enum ModelBakeEventHandler {
    ...
    public void onModelBake(ModelBakeEvent event) {
        ...
        IModel tinkertableUnbaked = MuseModelHelper.getModel(new ResourceLocation(Constants.MODID,
                "models/block/powerarmor_workbench.obj"));

        // new Tinker Table Inventory Model
        IModel luxCapacitorBaseUnbaked = MuseModelHelper.getModel(new ResourceLocation(Constants.MODID,
        "models/block/luxcapacitor/luxcapacitor_base.obj"));

        IModel luxcapacitorLenseUnbaked = MuseModelHelper.getModel(new ResourceLocation(Constants.MODID,
