...
public class CosmeticPresetSelectionSubframe extends ScrollableLabel {
    ...
    public CosmeticPresetSelectionSubframe(String name, Point2F Point2F, ItemSelectionFrame itemSelector, RelativeRect border) {
        super(new ClickableLabel(name, Point2F), border);
        this.name = name;
