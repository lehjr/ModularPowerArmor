...
public class TinkerTableGui extends ExtendedContainerScreen<TinkerTableContainer>{
    ...
    public TinkerTableGui(TinkerTableContainer containerIn, PlayerInventory playerInventory, ITextComponent titleIn) {
        ...
        itemSelectFrame = new ItemSelectionFrame(
                ...
                new Point2F(absX(-0.78F), absY(0.95F)),
                this.getBlitOffset(),
        ...
        moduleSelectFrame = new ModuleSelectionFrame(itemSelectFrame,
                new Point2F(absX(-0.75F), absY(-0.95f)),
                new Point2F(absX(-0.05F), absY(0.75f)),
                this.getBlitOffset(),
                Colour.DARKBLUE.withAlpha(0.8F),
        ...
        summaryFrame = new DetailedSummaryFrame(player,
                new Point2F(absX(0f), absY(-0.9f)),
                new Point2F(absX(0.95f), absY(-0.3f)),
                this.getBlitOffset(),
                Colour.DARKBLUE.withAlpha(0.8F),
                Colour.LIGHTBLUE.withAlpha(0.8F),
                itemSelectFrame);
        ...
        installFrame = new InstallSalvageFrame(
                containerIn,
                player,
                new Point2F(absX(-0.75F),
                        absY(0.6f)),
                new Point2F(absX(-0.05F),
                        absY(0.95f)),
                this.getBlitOffset(),
                Colour.DARKBLUE.withAlpha(0.8F),
                Colour.LIGHTBLUE.withAlpha(0.8F),
        ...
        tweakFrame = new ModuleTweakFrame(
                new Point2F(absX(0f), absY(-0.25f)),
                new Point2F(absX(0.95f), absY(0.95f)),
                getBlitOffset(),
                Colour.DARKBLUE.withAlpha(0.8F),
                Colour.LIGHTBLUE.withAlpha(0.8F),
