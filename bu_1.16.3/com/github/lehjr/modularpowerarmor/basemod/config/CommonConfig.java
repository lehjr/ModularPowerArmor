...
//
//    public static float baseMaxHeatHelmet() {
//        double val = Optional.ofNullable(commonConfig != null? GENERAL_BASE_MAX_HEAT_HELMET.get() : null).orElse(5.0D);
//        return (float) val;
//    }
//
//    public static float baseMaxHeatChest() {
//        double val = Optional.ofNullable(commonConfig != null? GENERAL_BASE_MAX_HEAT_CHEST.get() : null).orElse(5.0D);
//        return (float) val;
//    }
//
//    public static float baseMaxHeatLegs() {
//        double val = Optional.ofNullable(commonConfig != null? GENERAL_BASE_MAX_HEAT_LEGS.get() : null).orElse(5.0D);
//        return (float) val;
//    }
//
//    public static float baseMaxHeatFeet() {
//        double val = Optional.ofNullable(commonConfig != null? GENERAL_BASE_MAX_HEAT_FEET.get() : null).orElse(5.0D);
//        return (float) val;
//    }
//
//    public static float baseMaxHeatPowerFist() {
//        double val = Optional.ofNullable(commonConfig != null? GENERAL_BASE_MAX_HEAT_POWERFIST.get() : null).orElse(5.0D);
//        return (float) val;
//    }
//
...
//    public static ForgeConfigSpec.ConfigValue<List<?>> GENERAL_VEIN_MINER_BLOCK_LIST;
//
...
//     * FIXME: waiting on a PR for Forge for float config values
//     */
...
//
//        @Override
//        public float getBasePropertyFloatOrDefault (
//                EnumModuleCategory category,
//                @Nonnull ItemStack module,
//                String propertyName, float baseVal) {
//
...
//
//        @Override
//        public float getTradeoffPropertyFloatOrDefault(
//                EnumModuleCategory category,
//                @Nonnull ItemStack module,
//                String tradeoffName,
//                String propertyName,
