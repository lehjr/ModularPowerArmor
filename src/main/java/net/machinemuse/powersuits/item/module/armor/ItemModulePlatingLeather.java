...
public class ItemModulePlatingLeather extends ItemAbstractPowerModule {
    ...
    public class CapProvider implements ICapabilityProvider {
        ...
        public CapProvider(@Nonnull ItemStack module) {
            ...
            this.moduleCap.addBasePropertyDouble(MPSConstants.ARMOR_VALUE_PHYSICAL, 3, NuminaConstants.MODULE_TRADEOFF_PREFIX + MPSConstants.ARMOR_POINTS);
            this.moduleCap.addBasePropertyDouble(MPSConstants.MAXIMUM_HEAT, 75);
        }
