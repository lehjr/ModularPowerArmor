...
public class ItemModuleTransparentArmor extends ItemAbstractPowerModule {
    ...
    public class CapProvider implements ICapabilityProvider {
        ...
        public CapProvider(@Nonnull ItemStack module) {
            this.module = module;
            this.moduleCap = new PowerModule(module, EnumModuleCategory.CATEGORY_COSMETIC, EnumModuleTarget.ARMORONLY, MPSConfig.INSTANCE);
