package net.machinemuse.powersuits.item.module.tool;// package andrew.powersuits.modules;
//
...
//  * 8:42 PM 6/17/13
//  */
// public class OCTerminalModule extends ItemAbstractPowerModule implements IRightClickModule {
// public static final String MODULE_OC_TERMINAL = "OC Terminal";
// private ItemStack terminal;
//
// public OCTerminalModule((())) {
//         super(validItems);
