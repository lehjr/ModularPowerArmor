...
//import net.machinemuse.powersuits.client.gui.MuseContainerScreen;
...
//
//public class KeyConfigGui extends MuseContainerScreen<PlayerContainer> {
...
//
//    public KeyConfigGui(PlayerContainer container, PlayerInventory playerInventory, ITextComponent title) {
...
////        this.xSize = 400;
////        this.ySize = 244;
//        this.xSize = minecraft.mainWindow.getScaledWidth() - 50;
//        this.ySize = minecraft.mainWindow.getScaledHeight() - 50;
//
