...
//    protected MuseContainerScreen gui;
//    protected boolean selecting;
//    protected ClickableButton newKeybindButton;
//    protected ClickableButton trashKeybindButton;
//    protected long takenTime;
//
//    public KeybindConfigFrame(MuseContainerScreen gui, MusePoint2D ul, MusePoint2D br, PlayerEntity player) {
//        modules = new HashSet();
...
//            if (!keyBindingHelper.keyBindingHasKey(key)) {
//                addKeybind(key, true);
//            } else if (CommonConfig.moduleConfig.GENERAL_ALLOW_CONFLICTING_KEYBINDS.get()) {
