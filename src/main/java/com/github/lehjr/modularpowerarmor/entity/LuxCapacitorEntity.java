...
public class LuxCapacitorEntity extends EntityThrowable implements IEntityAdditionalSpawnData {
    public Colour color;

    public LuxCapacitorEntity(World par1World) {
        super(par1World);
        if (color == null)
            color = Colour.WHITE;
    }

    public LuxCapacitorEntity(World world, EntityLivingBase shootingEntity, Colour color) {
