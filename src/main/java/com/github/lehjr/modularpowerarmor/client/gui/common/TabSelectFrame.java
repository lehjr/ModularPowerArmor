...
import com.github.lehjr.modularpowerarmor.client.gui.modding.cosmetic.CosmeticGui;
...
public class TabSelectFrame extends ScrollableFrame {
    ...
    public TabSelectFrame(PlayerEntity player, int exclude, float zLevel) {
        super(new Point2D(0, 0), new Point2D(0, 0), zLevel, Colour.WHITE.withAlpha(0), Colour.WHITE.withAlpha(0));
        this.player = player;
