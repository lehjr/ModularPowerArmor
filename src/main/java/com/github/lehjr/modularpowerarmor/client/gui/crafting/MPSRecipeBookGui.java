...
public class MPSRecipeBookGui extends RecipeBookGui {
    ...
    public void initSearchBar(boolean widthTooNarrow) {
        ...
        outerFrame.setTargetDimensions(new Point2F(guiLeft, guiTop), new Point2F(146, 166));
        innerFrame.setTargetDimensions(new Point2F(guiLeft + 7, guiTop + 7), new Point2F( 146 - 14, 166 -14));
