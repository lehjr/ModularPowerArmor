...
public class ColourPickerFrame extends ScrollableFrame {
    ...
    public ColourPickerFrame(Point2D topleft, Point2D bottomright, float zLevel, Colour borderColour, Colour insideColour, ItemSelectionFrame itemSelector) {
    ...
    public ScrollableSlider getScrollableSlider(String id, ScrollableRectangle prev, int index) {
        ...
        ClickableSlider slider =
                new ClickableSlider(new Point2D(newborder.centerx(), newborder.centery()), newborder.width() - 15, id, new TranslationTextComponent(MPALibConstants.MODULE_TRADEOFF_PREFIX + id));
