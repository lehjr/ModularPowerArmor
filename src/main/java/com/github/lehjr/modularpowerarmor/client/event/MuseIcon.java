...
//
        ...
        tinkerTableTexture = register(event, "block/modularpowerarmorworkbench");
    }

    private static TextureAtlasSprite register(TextureStitchEvent.Pre event, String location) {
        System.out.println("fixme!!");

        ResourceLocation res = new ResourceLocation(MPAConstants.RESOURCE_DOMAIN, location);
//        if (event.getMap() == Minecraft.getInstance().getModelManager().getAtlasTexture().getTextureMap()) {
//            event.addSprite(res);
//        }
