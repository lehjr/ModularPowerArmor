...
//     */
//    public static LoadingCache<ColoredQuadHelper, List<BakedQuad>> luxCapColoredQuadMap = CacheBuilder.newBuilder()
//            .maximumSize(40)
//            .build(new CacheLoader<ColoredQuadHelper, List<BakedQuad>>() {
//                @Override
//                public List<BakedQuad> load(ColoredQuadHelper key) throws Exception {
//                    return getQuads(key.getColour(), key.getFacing());
//                }
//
//                public IBakedModel getBase(@Nullable Direction facing) {
//                    return ModelHelper.loadBakedModel(baseModelLocation, TransformationMatrix.from((facing != null) ? facing : Direction.NORTH));
//                }
//
//                public IBakedModel getLens(@Nullable Direction facing) {
//                    return ModelHelper.loadBakedModel(lensModelLocation, TransformationMatrix.from((facing != null) ? facing : Direction.NORTH));
//                }
//
//                List<BakedQuad> getBaseQuads(@Nullable Direction facing) {
//                    facing = (facing != null) ? facing : Direction.NORTH;
//
//                    TransformationMatrix transform = TransformationMatrix.from(facing);
