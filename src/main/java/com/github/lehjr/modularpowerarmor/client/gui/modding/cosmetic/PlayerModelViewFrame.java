...
public class PlayerModelViewFrame extends ScrollableFrame {
    ...
    public PlayerModelViewFrame(ItemSelectionFrame itemSelector, Point2D topleft, Point2D bottomright, float zLevel, Colour backgroundColour, Colour borderColour) {
