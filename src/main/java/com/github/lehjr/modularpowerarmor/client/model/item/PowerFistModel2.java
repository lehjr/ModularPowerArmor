...
public class PowerFistModel2 extends Model {
    ...
    public PowerFistModel2() {
        ...
        partlMap.put("powerfist.mainarm", mainarm);
        partlMap.put("powerfist.armorright", armorright);
        partlMap.put("powerfist.armorleft", armorleft);
        partlMap.put("powerfist.wristtopright", wristtopright);
        partlMap.put("powerfist.wristtopleft", wristtopleft);
        partlMap.put("powerfist.wristbottomright", wristbottomright);
        partlMap.put("powerfist.wristbottomleft", wristbottomleft);
        partlMap.put("powerfist.index1", index1);
        partlMap.put("powerfist.index2", index2);
        partlMap.put("powerfist.middlefinger1", middlefinger1);
        partlMap.put("powerfist.middlefinger2", middlefinger2);
        partlMap.put("powerfist.ringfinger1", ringfinger1);
        partlMap.put("powerfist.ringfinger2", ringfinger2);
        partlMap.put("powerfist.pinky1", pinky1);
        partlMap.put("powerfist.pinky2", pinky2);
        partlMap.put("powerfist.thumb1", thumb1);
        partlMap.put("powerfist.thumb2", thumb2);
        partlMap.put("powerfist.fingerguard", fingerguard);
        partlMap.put("powerfist.crystalholder", crystalholder);
        partlMap.put("powerfist.crystal", crystal);
        partlMap.put("powerfist.supportright1", supportright1);
        partlMap.put("powerfist.supportright2", supportright2);
        partlMap.put("powerfist.supportright3", supportright3);
        partlMap.put("powerfist.supportright4", supportright4);
        partlMap.put("powerfist.supportright5", supportright5);
        partlMap.put("powerfist.supportbaseright", supportbaseright);
        partlMap.put("powerfist.palm", palm);
        partlMap.put("powerfist.supportbaseleft", supportbaseleft);
        partlMap.put("powerfist.supportleftfront", supportleftfront);
        partlMap.put("powerfist.supportrightfront", supportrightfront);
        partlMap.put("powerfist.supportleft1", supportleft1);
        partlMap.put("powerfist.supportleft2", supportleft2);
        partlMap.put("powerfist.supportleft3", supportleft3);
        partlMap.put("powerfist.supportleft4", supportleft4);
        partlMap.put("powerfist.supportleft5", supportleft5);
    }

/*
"": {
    powerfist_left.supportrightfront: {
        part: supportrightfront
        model: powerfist_left
    }
    powerfist.palm: {
        part: palm
        model: powerfist
    }
    powerfist_fingers_normal.middlefinger2: {
        part: middlefinger2
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal_left.ringfinger2: {
        part: ringfinger2
        model: powerfist_fingers_normal_left
    }
    powerfist.mainarm: {
        part: mainarm
        model: powerfist
    }
    powerfist_fingers_normal_left.ringfinger1: {
        part: ringfinger1
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_firing_left.middlefinger1: {
        part: middlefinger1
        model: powerfist_fingers_firing_left
    }
    powerfist.supportbaseright: {
        part: supportbaseright
        model: powerfist
    }
    powerfist_fingers_normal.index2: {
        part: index2
        model: powerfist_fingers_normal
    }
    powerfist_fingers_firing_left.middlefinger2: {
        part: middlefinger2
        model: powerfist_fingers_firing_left
    }
    powerfist_fingers_normal.middlefinger1: {
        part: middlefinger1
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal.pinky1: {
        part: pinky1
        model: powerfist_fingers_normal
    }
    powerfist_left.palm: {
    ...
    powerfist_fingers_normal.index1: {
        part: index1
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal.pinky2: {
        part: pinky2
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal_left.middlefinger1: {
        part: middlefinger1
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_firing_left.pinky1: {
        part: pinky1
        model: powerfist_fingers_firing_left
    }
    powerfist_fingers_normal.thumb2: {
        part: thumb2
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal_left.middlefinger2: {
        part: middlefinger2
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_firing_left.pinky2: {
        part: pinky2
        model: powerfist_fingers_firing_left
    }
    powerfist_fingers_normal.thumb1: {
        part: thumb1
        model: powerfist_fingers_normal
    }
    armor2.bootglow1: {
    ...
    powerfist_left.crystalholder: {
        part: crystalholder
        model: powerfist_left
    }
    powerfist_left.supportright5: {
        part: supportright5
        model: powerfist_left
    }
    powerfist_left.supportright4: {
        part: supportright4
        model: powerfist_left
    }
    powerfist_left.supportright3: {
        part: supportright3
        model: powerfist_left
    }
    powerfist_left.supportright2: {
        part: supportright2
        model: powerfist_left
    }
    powerfist_left.supportright1: {
        part: supportright1
        model: powerfist_left
    }
    powerfist.supportleftfront: {
        part: supportleftfront
        model: powerfist
    }
    powerfist.crystalholder: {
        part: crystalholder
        model: powerfist
    }
    powerfist_fingers_firing_left.thumb2: {
        part: thumb2
        model: powerfist_fingers_firing_left
    }
    powerfist_left.fingerguard: {
        part: fingerguard
        model: powerfist_left
    }
    powerfist_fingers_firing_left.thumb1: {
        part: thumb1
        model: powerfist_fingers_firing_left
    }
    powerfist.armorright: {
        part: armorright
        model: powerfist
    }
    powerfist_left.crystal: {
        part: crystal
        model: powerfist_left
    }
    powerfist.wristtopright: {
        part: wristtopright
        model: powerfist
    }
    powerfist_fingers_firing.thumb1: {
        part: thumb1
        model: powerfist_fingers_firing
    }
    powerfist_fingers_firing_left.index2: {
        part: index2
        model: powerfist_fingers_firing_left
    }
    powerfist_left.armorright: {
        part: armorright
        model: powerfist_left
    }
    powerfist_fingers_firing.thumb2: {
        part: thumb2
        model: powerfist_fingers_firing
    }
    powerfist_fingers_firing_left.index1: {
        part: index1
        model: powerfist_fingers_firing_left
    }
    powerfist.supportbaseleft: {
        part: supportbaseleft
        model: powerfist
    }
    powerfist.wristbottomleft: {
        part: wristbottomleft
        model: powerfist
    }
    powerfist_left.supportbaseright: {
        part: supportbaseright
        model: powerfist_left
    }
    colours: ints(
    ...
    powerfist_left.wristbottomright: {
        part: wristbottomright
        model: powerfist_left
    }
    powerfist.supportright1: {
        part: supportright1
        model: powerfist
    }
    powerfist_left.supportleftfront: {
        part: supportleftfront
        model: powerfist_left
    }
    powerfist_fingers_firing.pinky1: {
        part: pinky1
        model: powerfist_fingers_firing
    }
    powerfist_fingers_normal_left.index2: {
        part: index2
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_firing.index1: {
        part: index1
        model: powerfist_fingers_firing
    }
    powerfist_fingers_firing.pinky2: {
        part: pinky2
        model: powerfist_fingers_firing
    }
    powerfist_fingers_normal_left.pinky1: {
        part: pinky1
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_normal_left.index1: {
        part: index1
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_normal_left.pinky2: {
        part: pinky2
        model: powerfist_fingers_normal_left
    }
    powerfist.fingerguard: {
        part: fingerguard
        model: powerfist
    }
    powerfist_fingers_firing.index2: {
        part: index2
        model: powerfist_fingers_firing
    }
    powerfist_left.mainarm: {
        part: mainarm
        model: powerfist_left
    }
    powerfist.wristtopleft: {
        part: wristtopleft
        model: powerfist
    }
    powerfist.crystal: {
    ...
    powerfist_fingers_normal.ringfinger1: {
        part: ringfinger1
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal.ringfinger2: {
        part: ringfinger2
        model: powerfist_fingers_normal
    }
    powerfist_fingers_normal_left.thumb2: {
        part: thumb2
        model: powerfist_fingers_normal_left
    }
    powerfist_fingers_normal_left.thumb1: {
        part: thumb1
        model: powerfist_fingers_normal_left
    }
    powerfist_left.wristtopright: {
        part: wristtopright
        model: powerfist_left
    }
    powerfist.armorleft: {
    ...
    powerfist_fingers_firing_left.ringfinger1: {
        part: ringfinger1
        model: powerfist_fingers_firing_left
    }
    powerfist_fingers_firing.middlefinger2: {
        part: middlefinger2
        model: powerfist_fingers_firing
    }
    powerfist_left.supportbaseleft: {
        part: supportbaseleft
        model: powerfist_left
    }
    powerfist_fingers_firing_left.ringfinger2: {
        part: ringfinger2
        model: powerfist_fingers_firing_left
    }
    powerfist.supportrightfront: {
        part: supportrightfront
        model: powerfist
    }
    powerfist_fingers_firing.middlefinger1: {
        part: middlefinger1
        model: powerfist_fingers_firing
    }
    powerfist_left.supportleft5: {
        part: supportleft5
        model: powerfist_left
    }
    powerfist.wristbottomright: {
        part: wristbottomright
        model: powerfist
    }
    powerfist_fingers_firing.ringfinger1: {
        part: ringfinger1
        model: powerfist_fingers_firing
    }
    powerfist_left.wristbottomleft: {
        part: wristbottomleft
        model: powerfist_left
    }
    powerfist_fingers_firing.ringfinger2: {
        part: ringfinger2
        model: powerfist_fingers_firing
    }
    powerfist_left.supportleft4: {
        part: supportleft4
        model: powerfist_left
    }
    powerfist.supportleft5: {
        part: supportleft5
        model: powerfist
    }
    powerfist_left.armorleft: {
        part: armorleft
        model: powerfist_left
    }
    powerfist_left.supportleft3: {
        part: supportleft3
        model: powerfist_left
    }
    powerfist_left.supportleft2: {
        part: supportleft2
        model: powerfist_left
    }
    powerfist_left.supportleft1: {
        part: supportleft1
        model: powerfist_left
    }
    powerfist.supportright3: {
        part: supportright3
        model: powerfist
    }
    powerfist.supportleft2: {
        part: supportleft2
        model: powerfist
    }
    mps_boots.boots2: {
    ...
    powerfist.supportright2: {
        part: supportright2
        model: powerfist
    }
    powerfist.supportleft1: {
        part: supportleft1
        model: powerfist
    }
    powerfist.supportright5: {
        part: supportright5
        model: powerfist
    }
    powerfist.supportleft4: {
        part: supportleft4
        model: powerfist
    }
    powerfist.supportright4: {
        part: supportright4
        model: powerfist
    }
    powerfist.supportleft3: {
        part: supportleft3
        model: powerfist
    }
}
