//package com.github.lehjr.modularpowerarmor.client.gui.tinker.frame;
//
...
////        this.saveAsLabel = new ScrollableLabel(I18n.format("gui.modularpowerarmor.saveAs"),  new MuseRelativeRect(border.left(), colourpicker.getBorder().top() + 20, border.right(), colourpicker.getBorder().top() + 30)).setEnabled(false);
...
////                BiMap<String, CompoundNBT> presetMap = MPASettings::getModuleConfig.getCosmeticPresets(itemStack);
...
////        if (usingCosmeticPresets ||
////                (!MPASettings::getModuleConfig.COSMETIC_ALLOW_POWER_FIST_CUSTOMIZATOIN.get() &&
...
////        return MPASettings::getModuleConfig.getPresetNBTFor(itemStack, "Default");
////    }
////
...
////                            MPSPackets.sendToServer(new MusePacketCosmeticInfo(player.getEntityId(), itemSelector.getSelectedItem().inventorySlot, MPALibConstants.TAG_RENDER, nbt));
////                        }
////                        // cancel creation
