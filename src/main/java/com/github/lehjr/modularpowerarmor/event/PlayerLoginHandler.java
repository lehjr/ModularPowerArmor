...
import com.github.lehjr.modularpowerarmor.network.packets.MusePacketClientOnLogin;
...
public final class PlayerLoginHandler {
    ...
    public static void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        if (player != null) {
            MPAPackets.CHANNEL_INSTANCE.send(PacketDistributor.PLAYER.with(()-> (ServerPlayerEntity) player), new MusePacketClientOnLogin());
        }
    }
