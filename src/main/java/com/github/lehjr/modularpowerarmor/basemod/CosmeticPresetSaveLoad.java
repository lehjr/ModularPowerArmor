...
public class CosmeticPresetSaveLoad {
    ...
    static String getConfigDirString() {
        if (configDirString.isEmpty()) { // fixme?
            configDirString = ConfigHelper.getConfigFolder(MPAConstants.MOD_ID).getAbsolutePath();
        }
    ...
    public static void copyPresetsFromJar(String configDir) {
        ...
        try {
            URI uri = CosmeticPresetSaveLoad.class.getResource("/data/modularpowerarmor/cosmeticpresets/").toURI();
            if ("jar".equals(uri.getScheme())) {
                ...
                sourcePath = sourcePath.resolve("data/modularpowerarmor/cosmeticpresets");
