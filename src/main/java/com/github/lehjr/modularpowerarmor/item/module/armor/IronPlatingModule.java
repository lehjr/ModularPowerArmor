...
public class IronPlatingModule extends AbstractPowerModule {
    public IronPlatingModule(String regName) {
        super(regName);
    }
    ...
    public class CapProvider implements ICapabilityProvider {
        ...
        public CapProvider(@Nonnull ItemStack module) {
            this.module = module;
                ...
                moduleCap.addBasePropertyDouble(MPAConstants.ARMOR_VALUE_PHYSICAL, 4, MPALIbConstants.MODULE_TRADEOFF_PREFIX + MPAConstants.ARMOR_POINTS);
                moduleCap.addBasePropertyDouble(HeatCapability.MAXIMUM_HEAT, 300);
