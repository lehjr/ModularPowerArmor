...
public class OreScannerModule extends AbstractPowerModule implements IRightClickModule, IPlayerTickModule {
    ...
    public String getDataName() {
        return ModuleConstants.MODULE_ORE_SCANNER__DATANAME;
    }
