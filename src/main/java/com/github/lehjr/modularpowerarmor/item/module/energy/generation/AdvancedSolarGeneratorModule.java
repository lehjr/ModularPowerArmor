...
public class AdvancedSolarGeneratorModule extends AbstractPowerModule {
    ...
    public class CapProvider implements ICapabilityProvider {
        ...
        public CapProvider(@Nonnull ItemStack module) {
            ...
            this.ticker.addBasePropertyFloat(MPAConstants.ENERGY_GENERATION_DAY, 45000, "RF");
            this.ticker.addBasePropertyFloat(MPAConstants.ENERGY_GENERATION_NIGHT, 1500, "RF");
            this.ticker.addBasePropertyFloat(MPAConstants.HEAT_GENERATION_DAY, 15);
            this.ticker.addBasePropertyFloat(MPAConstants.HEAT_GENERATION_NIGHT, 5);
        }
