...
public class DiamondPlatingModule extends AbstractPowerModule {
    ...
    public class CapProvider implements ICapabilityProvider {
        ...
        public CapProvider(@Nonnull ItemStack module) {
            ...
            moduleCap.addBasePropertyFloat(MPAConstants.ARMOR_VALUE_PHYSICAL, 5, MPALIbConstants.MODULE_TRADEOFF_PREFIX + MPAConstants.ARMOR_POINTS);
            moduleCap.addBasePropertyFloat(MPAConstants.MAXIMUM_HEAT, 400);
