 ...
 */
public class RefinedStorageWirelessModule extends AbstractPowerModule implements IRightClickModule {
...
//            return new NetworkItemWirelessCraftingGrid(handler, player, emulatedTool);
    ...
    public String getDataName() {
        return ModuleConstants.MODULE_REF_STOR_WIRELESS__DATANAME;
    }
