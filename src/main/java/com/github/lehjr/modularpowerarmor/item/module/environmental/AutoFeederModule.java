...
public class AutoFeederModule extends AbstractPowerModule implements IToggleableModule, IPlayerTickModule {
    public AutoFeederModule(EnumModuleTarget moduleTarget) {
        ...
        addBasePropertyDouble(ModuleConstants.EATING_ENERGY_CONSUMPTION, 100);
        addBasePropertyDouble(ModuleConstants.EATING_EFFICIENCY, 50);
        addTradeoffPropertyDouble(ModuleConstants.EFFICIENCY, ModuleConstants.EATING_ENERGY_CONSUMPTION, 1000, "RF");
        addTradeoffPropertyDouble(ModuleConstants.EFFICIENCY, ModuleConstants.EATING_EFFICIENCY, 50);
    }
    ...
    public String getDataName() {
        return ModuleConstants.MODULE_AUTO_FEEDER__DATANAME;
    }
    ...
    public void onPlayerTickActive(EntityPlayer player, ItemStack item) {
        ...
        double eatingEnergyConsumption = ModuleManager.INSTANCE.getOrSetModularPropertyDouble(item, ModuleConstants.EATING_ENERGY_CONSUMPTION);
        double efficiency = ModuleManager.INSTANCE.getOrSetModularPropertyDouble(item, ModuleConstants.EATING_EFFICIENCY);
