...
public class InvisibilityModule extends AbstractPowerModule implements IPlayerTickModule, IToggleableModule {
    ...
    public String getDataName() {
        return ModuleConstants.MODULE_ACTIVE_CAMOUFLAGE__DATANAME;
    }
