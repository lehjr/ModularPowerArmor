...
public class AxeModule extends AbstractPowerModule {
    ...
    public class CapProvider implements IPowerModuleCapabilityProvider {
        ...
        public CapProvider(@Nonnull ItemStack module) {
            ...
            this.blockBreaking.addTradeoffPropertyDouble(Constants.OVERCLOCK, Constants.HARVEST_SPEED, 22);
        }
        ...
        class BlockBreaker extends PowerModule implements IBlockBreakingModule {
            ...
            @Override
            public boolean onBlockDestroyed(@Nonnull ItemStack itemStack, World world, IBlockState state, BlockPos pos, EntityLivingBase entityLiving, int i) {
