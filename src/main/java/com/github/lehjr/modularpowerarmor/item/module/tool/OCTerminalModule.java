package com.github.lehjr.modularpowerarmor.item.module.tool;// package andrew.modularpowerarmor.modules;
//
...
//  * 8:42 PM 6/17/13
//  */
// public class OCTerminalModule extends AbstractPowerModule implements IRightClickModule {
